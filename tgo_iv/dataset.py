...
def _single_index_loader(ds, index: int, batch_size: int, num_workers: int, pin_memory: bool, seed: int):
    import torch
...
def build_loaders(
    ...
    trajectory_loader = _single_index_loader(val_ds, trajectory_index, trajectory_batch_size, num_workers, pin_memory, seed)
    topology_loader = _single_index_loader(val_ds, topology_index, topology_batch_size, num_workers, pin_memory, seed)
    return train_loader, val_loader, analysis_loader, trajectory_loader, topology_loader
